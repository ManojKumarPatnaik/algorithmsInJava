...
public class StoneGameIXLeetcode2029 {
	...
	public boolean stoneGameIX(int[] stones) {
		...
		// the combinations of 1's and 2's will work with each other in a complementary
		// way.
		...
		// so, if all three digits chosen are the same then bob wins, but if there is
		// another option then alice wins
		...
		// if the difference of number counts is more than 2 then alice can always force
		// bob
		// [3,1,2,2,2] ->
		// [3,1,2,2,2,2] ->
		if (larger > smaller + 2) {
