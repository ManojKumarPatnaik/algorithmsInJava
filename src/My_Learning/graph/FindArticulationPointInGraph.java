...
public class FindArticulationPointInGraph {
	...
	void printArticulationPoints(ArrayList<ArrayList<Integer>> adj, int n) {
		int vis[] = new int[n];
		int tin[] = new int[n];
		int low[] = new int[n];
		...
		for (int i = 0; i < n; i++) {
			if (isArticulation[i] == 1)
				System.out.println("Articulation point/node :: " + i);
		}
	}
	...
	public static void main(String args[]) {
		...
		FindArticulationPointInGraph obj = new FindArticulationPointInGraph();
		obj.printArticulationPoints(adj, n);
