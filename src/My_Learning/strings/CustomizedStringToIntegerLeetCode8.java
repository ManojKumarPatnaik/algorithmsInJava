...
public class CustomizedStringToIntegerLeetCode8 {
	...
	public int myAtoi(String str) {
		...
		while (index < len && isDigit(str.charAt(index))) {
			 ...
			 * '0' --> 5 or else it will store the ASCII value of 5 i.e. 53, so we do
			 * 53(ASCII of 5) - 48(ASCII of 0(zero)) to get 5 as int
			 */
