...
public class FindSubsequenceWithKLargestSumLeetcode2099 {
	...
	public int[] maxSubsequence(int[] nums, int k) {
		// Create proirity queue with min priority queue so that min element will be
		// removed first, with index
